<template>
  ...
  >
    ...
    <Handle
      ...
      class="w-3 h-3 border-2 bg-gray-300 border-gray-100"
    />
    ...
    <div class="flex flex-col flex-grow">
      ...
      <div class="flex items-center justify-between mb-2">
        <div class="text-gray-900 font-bold text-base truncate flex-1 mr-2" :title="data.label">
          {{ data.label }}
        </div>
      ...
      <div v-if="githubRepo" class="flex items-center space-x-1 mb-3">
        ...
        <span class="text-xs text-gray-500 truncate" :title="githubRepo">{{ githubRepoShort }}</span>
      </div>
      ...
      <div v-if="showProgressBar" class="mb-3">
        <div class="flex items-center justify-between mb-1">
          ...
          <span class="text-xs font-semibold text-gray-700">{{ contextPercentDisplay }}%</span>
        </div>
      ...
      <div class="mb-3">
        ...
        <div v-if="currentTask" class="mb-2">
          <div class="flex items-center space-x-1 mb-1">
            ...
            <span class="text-xs text-gray-500">Current Task</span>
          </div>
          <div class="text-xs font-medium text-gray-700 truncate pl-4" :title="currentTask">
            {{ currentTask }}
          </div>
        </div>
        ...
        <div class="flex items-center justify-between mb-1">
          ...
          <span class="text-xs font-semibold text-gray-700">{{ taskProgressDisplay }}</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
          <div
      ...
      <button
        class="nodrag w-full px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg text-xs font-semibold transition-all duration-200 border border-blue-200 hover:border-blue-300 mt-auto"
        @click="viewDetails"
      >
        View Details
      </button>
