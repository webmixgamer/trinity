      ...
      <div class="px-4 py-6 sm:px-0">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-6">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-medium text-gray-900">Bulk Import Credentials</h2>
            <button
              v-if="!showBulkImport"
          ...
          <div v-if="showBulkImport">
            ...
            <div class="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <div class="flex items-center justify-between mb-2">
                <label class="block text-sm font-medium text-gray-700">Get credential template for:</label>
              </div>
...
CLOUDINARY_API_KEY=your-cloudinary-key"
            ...
            <!-- Import Results -->
            <div v-if="bulkImportResult" class="mt-4 p-4 rounded-md" :class="bulkImportResult.errors.length > 0 ? 'bg-yellow-50 border border-yellow-200' : 'bg-green-50 border border-green-200'">
              <div class="flex">
                ...
                <div class="ml-3">
                  <p class="text-sm font-medium" :class="bulkImportResult.errors.length === 0 ? 'text-green-800' : 'text-yellow-800'">
                    Created {{ bulkImportResult.created }} credential(s)
                    <span v-if="bulkImportResult.skipped > 0">, {{ bulkImportResult.skipped }} skipped</span>
                  </p>
                  <div v-if="bulkImportResult.errors.length > 0" class="mt-2 text-sm text-yellow-700">
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
          <div v-if="loading" class="p-8 text-center">
            ...
            <p class="mt-4 text-gray-500">Loading credentials...</p>
          </div>
          ...
          <div v-else-if="credentials.length === 0" class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">Get started by adding a credential or using bulk import.</p>
          </div>

          <ul v-else class="divide-y divide-gray-200">
            <li v-for="cred in credentials" :key="cred.id" class="p-6 hover:bg-gray-50">
                ...
                <div class="flex items-center flex-1">
                  ...
                  <div class="ml-4 flex-1">
                    <div class="flex items-center">
                      <h3 class="text-sm font-medium text-gray-900">{{ cred.name }}</h3>
                    ...
                    <p v-if="cred.description" class="mt-1 text-sm text-gray-500">{{ cred.description }}</p>
      ...
      <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Add Credential</h3>
