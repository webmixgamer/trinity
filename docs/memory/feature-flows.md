...
| GitHub Sync | Medium | [github-sync.md](feature-flows/github-sync.md) | GitHub sync for agents - Source mode (pull-only, default) or Working Branch mode (legacy bidirectional). **2026-02-28**: GIT-002 branch selection via URL syntax (`github:owner/repo@branch`) or `source_branch` param. **2026-01-30**: Shared users can now git pull (was owner-only) |
